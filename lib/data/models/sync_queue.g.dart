...
int _syncQueueItemEstimateSize(
  ...
  bytesCount += 3 + object.entityJson.length * 3;
...
void _syncQueueItemSerialize(
  ...
  writer.writeString(offsets[2], object.entityJson);
...
SyncQueueItem _syncQueueItemDeserialize(
  ...
  object.entityJson = reader.readString(offsets[2]);
  ...
  object.status =
      _SyncQueueItemstatusValueEnumMap[reader.readByteOrNull(offsets[6])] ??
          SyncStatus.pending;
...
extension SyncQueueItemQueryFilter
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition>
      entityJsonContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'entityJson',
        value: value,
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition>
      entityJsonMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'entityJson',
        wildcard: pattern,
...
extension SyncQueueItemQuerySortBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> sortByEntityJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entityJson', Sort.asc);
    });
  }

  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy>
      sortByEntityJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entityJson', Sort.desc);
    });
  }
...
extension SyncQueueItemQuerySortThenBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> thenByEntityJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entityJson', Sort.asc);
    });
  }
...
extension SyncQueueItemQueryWhereDistinct
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QDistinct> distinctByEntityJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'entityJson', caseSensitive: caseSensitive);
    });
  }
...
extension SyncQueueItemQueryProperty
  ...
  QueryBuilder<SyncQueueItem, String, QQueryOperations> entityJsonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'entityJson');
    });
  }
